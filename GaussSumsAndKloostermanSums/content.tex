...
\begin{definition}[Gauss Sum] \label{definition:gauss_}
    Let $\psi : \Fq \to \mathbb{C}^\times$ be a \CrefAndHyperrefIfExist{definition:trivial_character_of_a_group_valued_in_a_ring}{nontrivial} \CrefAndHyperrefIfExist{definition:character_of_a_group_valued_in_a_ring}{additive} \CrefAndHyperrefIfExist{definition:unitary_character_of_a_group_valued_in_the_complex_numbers}{(unitary)} \CrefAndHyperrefIfExist{definition:character_of_a_group_valued_in_a_ring}{character}, and let 
    $\chi : \Fq^\times \to \mathbb{C}^\times$
    be a \CrefAndHyperrefIfExist{definition:character_of_a_group_valued_in_a_ring}{multiplicative} (unitary) character.  
