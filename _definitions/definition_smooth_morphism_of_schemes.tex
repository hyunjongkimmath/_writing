...
Let \(f: X \to S\) be a \CrefAndHyperrefIfExist{definition:morphism_of_schemes}{morphism} of \CrefAndHyperrefIfExist{definition:scheme}{schemes}.
...
\begin{itemize}
    ...
    \item For every point \(x \in X\), the fiber \(X_{f(x)} = X \times_S \Spec \kappa(f(x))\) is a smooth variety over the \CrefAndHyperrefIfExist{definition:residue_field_of_a_scheme_at_a_point}{residue field} \(\kappa(f(x))\), equivalently, the sheaf of relative Kähler differentials \(\Omega_{X/S}\) is locally free of finite rank.
