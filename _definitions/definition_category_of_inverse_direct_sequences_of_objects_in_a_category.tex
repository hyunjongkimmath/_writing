...
\label{definition:category_of_inverse_direct_sequences_of_objects_in_a_category}
    ...
    \begin{enumerate}
        \item  The \hldef{category of inverse sequences} or \hldef{Pro-category indexed by $\mathbb{N}$}, denoted by \hl{$\mathrm{Pro}_{\mathbb{N}}(\mathcal{C})$} or \hl{$\calC^\bbN$} (following notation for \CrefAndHyperrefIfExist{definition:diagram_in_a_category_indexed_by_a_small_category}{functor categories}), is defined as follows:
        \begin{itemize}
