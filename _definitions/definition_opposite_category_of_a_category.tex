\begin{definition}[Opposite category] \label{definition:opposite_category_of_a_category}
    ...
    Let $\mathcal{C}$ be a \CrefAndHyperrefIfExist{definition:category}{(large) category}. The \hldef{opposite category} of $\mathcal{C}$, denoted \hl{$\mathcal{C}^{\mathrm{op}}$}, is defined as follows:
    \begin{itemize}
