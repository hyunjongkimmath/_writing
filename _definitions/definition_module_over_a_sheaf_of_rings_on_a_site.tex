\begin{definition} \label{definition:module_over_a_sheaf_of_rings_on_a_site}
    ...
    \begin{enumerate}
        \item 
        Let $\mathcal{C}$ be a \CrefAndHyperrefIfExist{definition:grothendieck_topology_on_a_category_site_covring_sieve_topologically_generating_family}{site}, and let $\mathcal{A}$ and $\mathcal{B}$ be \CrefAndHyperrefIfExist{definition:sheaf_on_a_site}{sheaves} of (not necessarily commutative) \CrefAndHyperrefIfExist{definition:ring}{rings} on $\mathcal{C}$. 
        ...
        \begin{enumerate}
            ...
            In particular, for every object $U \in \calC$, the abelian group $\calM(U)$ has the structure of an \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{$\calA(U)-\calB(U)$-bimodule}.
            ...
            exists. For rings $A$ and $B$, a \hldef{$A$-$B$-bimodule} or \hldef{bimodule over $(A,B)$ on $\calC$} is a bimodule over $(\underline{A}, \underline{B})$ where $\underline{A}$ and $\underline{B}$ are the \CrefAndHyperrefIfExist{definition:constant_sheaf_on_a_site_with_sheafification}{constant sheaves} on $\calC$ with values $A$ and $B$ respectively.
        ...
        \begin{enumerate}
            ...
            The collection of all $\mathcal{O}$-modules together with their morphisms of $\mathcal{O}$-modules forms the \hldef{category of $\mathcal{O}$-modules}, denoted \hl{$\mathbf{Mod}(\mathcal{O})$}. The Hom functors $\Hom_{\mathbf{Mod}(\mathcal{O})}$ of this category may be denoted by \hl{$\Hom_{\mathcal{O}}$}.
