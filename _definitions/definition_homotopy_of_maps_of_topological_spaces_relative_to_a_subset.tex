\begin{definition}[Homotopy of maps of topological spaces] \label{definition:homotopy_of_maps_of_topological_spaces_relative_to_a_subset}
    ...
    \begin{enumerate}
        ...
        If such an $H$ exists, we say $f$ and $g$ are \hldef{homotopic relative to $K$}, and we write \hl{$f \simeq g \text{ rel } K$} or \hl{$f \simeq_K g$}; this is an equivalence relation.

        In the case that $K = \emptyset$, a homotopy relative to $K$ is simply called a \hldef{homotopy}. We write we write \hl{$f \simeq g$} if a homotopy between $f$ and $g$ exists.
        ...
        If such an $H$ exists, we say $f$ and $g$ are \hldef{based homotopic relative to $K$}, and we write \hl{$f \simeq g \text{ rel } K$} or \hl{$f \simeq_K g$}. This is an equivalence relation.

        When $K = \{x_0\}$, one calls a homotopy of based maps relative to $K$ simply as a \hldef{homotopy of based maps} or \hldef{based homotopy}. We write \hl{$f \simeq g$} if such a homotopy exists.
    \end{enumerate}
\end{definition}