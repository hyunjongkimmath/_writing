\begin{definition} \label{definition:arithmetic_and_geometric_frobenius_automorphisms_of_algebraic_extensions_of_finite_fields}
    ...
    \begin{enumerate}
        ...
        \item For $n \geq 0$, the \hldef{$p^n$th power Frobenius automorphism on $k$} is the \CrefAndHyperrefIfExist{definition:absolute_p_nth_power_frobenius_endomorphism_of_a_ring_of_prime_characteristic}{absolute $p^n$th Frobenius endomorphism of $k$}; it is a field automorphism.
