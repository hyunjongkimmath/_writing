\begin{definition} \label{definition:canonical_truncation_of_chain_complexes_of_objects_in_an_abelian_category}
    ...
    \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{chain complex} 
    $A_\bullet$ in 
    \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{$\mathbf{Ch}(\mathcal{A})$} 
    are defined by
...
%     Let $\calA$ be an \CrefAndHyperrefIfExist{definition:abelian_category}{abelian category}.
% The \hldef{canonical truncations} of a \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{chain complex} $A_\bullet$ in \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{$\mathbf{Ch}(\mathcal{A})$} are defined by
