\begin{definition}  \label{definition:extension_of_scalars_base_change_induction_for_modules_along_ring_homomorphisms}
Let $R$ and $S$ be \CrefAndHyperrefIfExist{definition:ring}{rings} (not necessarily commutative), and let $f: R \to S$ be a \CrefAndHyperrefIfExist{definition:ring_homomorphism}{ring homomorphism}. This homomorphism gives $S$ the structure of an \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{$(R, R)$-bimodule} via \CrefAndHyperrefIfExist{definition:restriction_of_scalars_of_a_left_or_right_module_along_a_ring_homomorphism_from_the_base_ring}{restriction of scalars}. Let $T$ be a \CrefAndHyperrefIfExist{definition:ring}{ring}.

\begin{enumerate}
    \item 
    The \hldef{extension of scalars} (or \hldef{base change} or \hldef{induction}) along $f$ is defined separately for modules:
    \begin{itemize}
