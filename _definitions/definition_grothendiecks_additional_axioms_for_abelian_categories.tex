...
\begin{itemize}
  ...
  \item \hldef{Ab1}: Every morphism in $\calA$ has a \CrefAndHyperrefIfExist{definition:kernel_and_cokernel_of_a_morphism_in_a_pointed_category}{kernel and a cokernel}.
  ...
  \begin{itemize}
    \item Since $\mathcal{A}$ is abelian (and hence \CrefAndHyperrefIfExist{lemma:equalizer_coequalizer_in_an_additive_category_are_given_by_kernel_and_cokernel}{admits} \CrefAndHyperrefIfExist{definition:equalizer_and_coequalizer_of_morphisms_in_a_category}{equalizers} as \CrefAndHyperrefIfExist{definition:kernel_image_cokernel_of_a_module_homomorphism_over_rings}{kernels}), this is equivalent to requiring that $\mathcal{A}$ has all small \CrefAndHyperrefIfExist{definition:product_and_coproduct_of_objects_in_a_category}{coproducts} (direct sums).
  \end{itemize}

  \item \hldef{AB4}: The category $\mathcal{A}$ satisfies AB3, and coproducts are \CrefAndHyperrefIfExist{definition:exact_functor_between_abelian_categories}{exact} (when regarded as functors $\bigoplus_I: \calA^I \to \calA$).
  \begin{itemize}
  ...
  \item \hldef{AB5}: The category $\mathcal{A}$ satisfies AB3, and \CrefAndHyperrefIfExist{definition:projective_and_inductive_limits_in_categories}{filtered colimits} are \CrefAndHyperrefIfExist{definition:exact_functor_between_abelian_categories}{exact} (when regarded as functors $\varinjlim_J: \calA^J \to \calA$).
  \begin{itemize}
