...
\end{enumerate}
\TODO{equivalence class}
If such a function exists, the spaces $X$ and $Y$ are said to be \hldef{homeomorphic}, or that $X$ and $Y$ have the \hldef{same topological type} --- accordingly, the \hldef{topological type of a topological spaces} refers to its equivalence under the equivalence relation of homeomorhpic spaces. 
\end{definition}