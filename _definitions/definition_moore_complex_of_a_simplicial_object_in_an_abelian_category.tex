\begin{definition}[Moore complex of a simplicial object] \label{definition:moore_complex_of_a_simplicial_object_in_an_abelian_category}
    ...
    The \hldef{Moore complex}, synonymously called the \hldef{normalized chain complex} or \hldef{complex of normalized chains}, \hl{$M(X_\bullet) \in \mathrm{Ch}_{\geq 0}(\mathcal{A})$} associated to $X_\bullet$ is the \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{chain complex} given by:
    \begin{itemize}
