...
\begin{enumerate}
    \item  
    Let $A_\bullet$ be a \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{chain complex} in 
    ...
    These are \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{cochain complexes} with differentials inherited from $A^\bullet$. 
