...
\begin{enumerate}
    \item 
    Let $(M, +)$ be an \CrefAndHyperrefIfExist{definition:group}{abelian group} equipped with either the structure of a \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{$S-T$-bimodule} $(M, +, \cdot_S)$ or the structure of a $T-S$-bimodule $(M, +, \cdot_S)$.
