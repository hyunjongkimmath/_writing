\begin{definition} \label{definition:comparison_morphism_of_limits_and_colimits_under_functors}
    Let $\mathcal{C}$ and $\mathcal{D}$ be \CrefAndHyperrefIfExist{definition:category}{(large) categories}, $F: \mathcal{C} \to \mathcal{D}$ a \CrefAndHyperrefIfExist{definition:functor_between_categories}{functor}, and $D: \mathcal{J} \to \mathcal{C}$ a \CrefAndHyperrefIfExist{definition:diagram_in_a_category_indexed_by_a_category}{diagram} indexed by a small category $\mathcal{J}$.
