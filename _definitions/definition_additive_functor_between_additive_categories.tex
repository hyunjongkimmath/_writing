\begin{definition}[Additive functor] \label{definition:additive_functor_between_additive_categories}
    ...
    \begin{enumerate}
        \item Let $\mathcal{A}$ and $\mathcal{B}$ be \hyperrefIfExists{definition:additive_category}{pre-additive categories}. A functor
        ...
        \item Let $\mathcal{A}$ and $\mathcal{B}$ be \hyperrefIfExists{definition:additive_category}{additive categories}. A functor
        $$ F: \mathcal{A} \to \mathcal{B} $$
