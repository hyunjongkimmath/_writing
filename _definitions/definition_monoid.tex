\begin{definition}[Monoid] \label{definition:monoid}
    % EDITOR APPROVED
A \hldef{monoid} is a \CrefAndHyperrefIfExist{definition:semigroup}{semigroup} $(M,\cdot)$ such that there exists an \CrefAndHyperrefIfExist{definition:left_right_identity_element_of_a_binary_operation}{identity element} $e \in M$ for $\cdot$, i.e. $e$ has the property:
