\begin{definition}[Flat module over a ring] \label{definition:flat_left_right_module_over_a_ring}
    ...
    \begin{enumerate}
        ...
        \]
        \TODO{comment on how I might as well be talking about other more specific kinds of modules}
        ...
        Equivalently, $M$ is flat if $\mathrm{Tor}_1^R(-,M) = 0$(\Cref{definition:tor_functors_of_bimodules_of_rings}).
