...
An \CrefAndHyperrefIfExist{definition:zero_divisor_of_a_ring}{integral domain} $R$ is called a \hldef{Dedekind domain} or a \hldef{Dedekind ring} if it satisfies the following equivalent conditions:
