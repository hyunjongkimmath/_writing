...
Let $k \in \bbZ_{\geq 2} \cup \{\infty\}$, let $M$ be a $n$-dimensional \CrefAndHyperrefIfExist{definition:C_k_manifold}{$C^k$ manifold} with or without boundary, and let $U \subseteq M$ be open.
