\begin{definition} \label{definition:C_k_morphism_between_C_k_manifolds}
    ...
    $$ f : M \to N $$
    such that for every $p \in M$ there exist \CrefAndHyperrefIfExist{definition:chart_on_a_topological_manifold}{charts} $(U, \varphi) \in \mathcal{A}_M$ with $p \in U$ and $(V, \psi) \in \mathcal{A}_N$ with $f(p) \in V$ satisfying
    ...
    A \hldef{``continuously differentiable'' morphism} is one that is $C^1$.
