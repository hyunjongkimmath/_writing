...
\begin{enumerate}
    ...
    denoted by \hl{$(g, f) \mapsto g \odot f$};
    ...
    $$\hlin{ a_{h,g,f}: (h \odot g) \odot f \xrightarrow{\cong} h \odot (g \odot f); }$$
    \item For each pair of 0-cells $A, B$ and 1-cell $f: A \to B$, natural isomorphisms called the \hldef{left and right unitors},
    $$\hlin{ \lambda_f: I_B \odot f \xrightarrow{\cong} f \quad \text{and} \quad \rho_f: f \odot I_A \xrightarrow{\cong} f.  }$$
\end{enumerate}
