...
%         \item Let $U$ be a universe. A \hldef{$U$-(sheaf )topos} is a category equivalent to the category of \CrefAndHyperrefIfExist{definition:sheaf_on_a_site}{$U$-sheaves} (valued in $U$-sets) \cite[Expos\'e IV D\'efinition 1.1]{SGA4_I}
