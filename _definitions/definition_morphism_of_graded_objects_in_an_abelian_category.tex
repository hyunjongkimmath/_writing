\begin{definition} \label{definition:morphism_of_graded_objects_in_an_abelian_category}
    Let $\mathcal{A}$ be a \CrefAndHyperrefIfExist{definition:category}{category}. Let $M = \{M_n\}_{n \in \mathbb{Z}}$ and $N = \{N_n\}_{n \in \mathbb{Z}}$ be \CrefAndHyperrefIfExist{definition:graded_object_in_a_category}{graded objects} in $\mathcal{A}$.
