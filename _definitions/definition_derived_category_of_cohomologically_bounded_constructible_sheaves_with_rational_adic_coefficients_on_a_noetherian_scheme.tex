\begin{definition}[cf. {\cite[Between Corollary 10.1.21 and Lemma 10.1.22]{fu_ect}}] \label{definition:derived_category_of_cohomologically_bounded_constructible_sheaves_with_rational_adic_coefficients_on_a_noetherian_scheme}
    ...
    \begin{enumerate}
        ...
        For example, the above notion of $\Dbc(X,E)$ is often discussed for $E = \Qell$ where $\ell$ is a prime invertible on $X$. 
        ...
        For example, the above notion of $\Dbc(X,K)$ is often discussed for $K = \Qellbar$ where $\ell$ is a prime invertible on $X$. 
    \end{enumerate}
