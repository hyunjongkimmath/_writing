...
For any \CrefAndHyperrefIfExist{definition:pointed_topological_space}{pointed topological space} $(X,x_0)$ and integer $n \ge 0$, the \hldef{$n$-th homotopy set of $X$ at $x_0$}, denoted \hl{$\pi_n(X,x_0)$}, is defined as the set of all \CrefAndHyperrefIfExist{definition:homotopy_class_of_maps_of_topological_spaces_relative_to_a_subset}{homotopy classes (rel.\ $\partial I^n$)} of \CrefAndHyperrefIfExist{definition:map_of_pairs_of_topological_spaces}{paired maps}
