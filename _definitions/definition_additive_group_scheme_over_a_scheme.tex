...
Let $S$ be a scheme. 
The \hldef{additive group scheme over $S$} is the group scheme \hl{$\bbG_{a} = \bbG_{a,S}$} over $S$ defined by
...
\TextIfExists{definition:additive_group_sheaf_on_a_ringed_space}{
  The additive group scheme is the scheme representing the \CrefAndHyperrefIfExist{definition:additive_group_sheaf_on_a_ringed_space}{additive group sheaf $\bbG_a$} on $S$ as a ringed space. 
}
\end{definition}
