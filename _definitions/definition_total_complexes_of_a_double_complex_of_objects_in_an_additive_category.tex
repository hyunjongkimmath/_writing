...
Let $(A^{p,q},d'_A,d''_A)$ be a \CrefAndHyperrefIfExist{definition:double_complex_of_objects_in_an_additive_category}{double complex} in an \CrefAndHyperrefIfExist{definition:additive_category}{additive category} $\mathcal{A}$. For each integer $n$, define:
