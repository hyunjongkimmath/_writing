\begin{definition} \label{definition:symmetric_skew_symmetric_alternating_bilinear_form_on_a_module_over_a_ring}
    ...
    Let $R$ be a \CrefAndHyperrefIfExist{definition:ring}{(not necessarily commutative) ring}, and let $\beta: M \times M \to R$ be a \CrefAndHyperrefIfExist{definition:multilinear_map_of_modules_over_rings}{bilinear form} on a two-sided \CrefAndHyperrefIfExist{definition:module_of_a_ring}{$R$-module} $M$.
