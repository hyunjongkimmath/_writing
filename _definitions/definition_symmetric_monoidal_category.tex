...
A \hldef{symmetric monoidal category} is a \CrefAndHyperrefIfExist{definition:monoidal_category}{monoidal category} $(\mathcal{C}, \otimes, \mathbb{I})$ together with a natural isomorphism (symmetry)
...
\begin{itemize}
    ...
    \item the \textbf{symmetry coherence diagram} commutes:
        ...
        \]
\end{itemize}
A \hldef{closed symmetric monoidal category} usually refers to a symmetric monoidal category that is \CrefAndHyperrefIfExist{definition:closed_monoidal_category}{closed as a monoidal category}. 
\end{definition}