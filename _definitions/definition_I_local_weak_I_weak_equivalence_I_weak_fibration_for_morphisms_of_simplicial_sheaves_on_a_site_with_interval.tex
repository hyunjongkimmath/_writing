\begin{definition}[See {\cite[Section 2 Definition 3.1]{morel_voevodsky_1999}}] \label{definition:I_local_weak_I_weak_equivalence_I_weak_fibration_for_morphisms_of_simplicial_sheaves_on_a_site_with_interval}
    ...
    \begin{enumerate}
        ...
        induced by $i_0: \pt \to I$ is a bijection. Write \hl{$\calH_{s,I}(T)$} for the full subcategory of \CrefAndHyperrefIfExist{definition:simplicial_model_category_structure_on_the_category_of_simplicial_sheaves_on_a_small_site_and_simplicial_homotopy_category_of_a_site}{$\calH_s(T)$} of $I$-local objects. 
