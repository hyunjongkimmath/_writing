...
Equivalently, an $R$-algebra consists of a ring $A$ endowed with a \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{two-sided $R$-module} structure for which the scalar multiplication satisfies
