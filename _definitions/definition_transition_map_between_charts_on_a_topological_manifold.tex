\begin{definition}[Chart Transition Map]
    ...
    Given two \CrefAndHyperrefIfExist{definition:chart_on_a_topological_manifold}{charts} $(U, \varphi)$ and $(V, \psi)$ on a \CrefAndHyperrefIfExist{definition:topological_manifold}{topological manifold with boundary} $M$ such that $U \cap V \neq \emptyset$, the \hldef{chart transition map} or \hldef{change of coordinates map} (from $U$ to $V$) is the map
