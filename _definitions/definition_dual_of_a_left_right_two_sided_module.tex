...
Let $R$ be a \CrefAndHyperrefIfExist{definition:ring}{(not necessarily commutative) ring}. Depending on the \CrefAndHyperrefIfExist{definition:module_of_a_ring}{module} structure of $M$, we define its dual module as follows:
\begin{enumerate}
