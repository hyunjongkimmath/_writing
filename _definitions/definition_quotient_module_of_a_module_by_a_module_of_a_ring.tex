...
\begin{enumerate}
    \item Let $M$ be an \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{$R$-$S$-bimodule}. Let $N \subseteq M$ be a \CrefAndHyperrefIfExist{definition:submodule_of_a_module_over_a_ring}{submodule of $M$}.  
    ...
    is a surjective \CrefAndHyperrefIfExist{definition:homomorphism_of_modules_over_a_ring}{$R$-module homomorphism} with \CrefAndHyperrefIfExist{definition:kernel_image_cokernel_of_a_module_homomorphism_over_rings}{kernel} $N$.


    \item Let $M$ be a left/right/two-sided $R$-module. Let $N \subseteq M$ be a submodule of $M$. The \hldef{quotient $R$-module} \hl{$M/N$} is the quotient of $M$ by $N$ for their respective \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{natural bimodule structures}.
\end{enumerate}

    \TextIfExists{definition:quotient_object_of_an_object_of_an_abelian_category_by_a_subobject}{The quotient $M/N$ is the \CrefAndHyperrefIfExist{definition:quotient_object_of_an_object_of_an_abelian_category_by_a_subobject}{categorical quotient object} of $M$ by the \CrefAndHyperrefIfExist{definition:subobject_of_an_object_of_a_category}{subobject} $N$ in the appropriate category of modules}
