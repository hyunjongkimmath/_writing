...
Let $(C_\bullet, d^C)$ be a \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{chain complex} in $\mathcal{A}$ and $(D_\bullet, d^D)$ be a chain complex in $\mathcal{B}$, i.e.,
...
\begin{enumerate}
    ...
    where \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{$\mathbf{Ch}(\mathcal{A})$} denotes the category of chain complexes in $\mathcal{A}$.
\end{enumerate}
