...
A \hldef{topological $(R, S)$-bimodule} is an \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{$(R, S)$-bimodule} $M$ equipped with a \CrefAndHyperrefIfExist{definition:topological_space}{topology} such that:
\begin{enumerate}
