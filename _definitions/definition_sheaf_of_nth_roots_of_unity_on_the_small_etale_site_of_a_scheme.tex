...
Let $n$ be a positive integer invertible on the \CrefAndHyperrefIfExist{definition:scheme}{scheme} $X$. The \CrefAndHyperrefIfExist{definition:sheaf_on_a_site}{sheaf} \hl{$\mu_n$} on \CrefAndHyperrefIfExist{definition:small_etale_site_of_a_scheme}{$X_{\text{ét}}$} is defined as the kernel of the multiplication-by-$n$ map on $\mathbb{G}_m$:
...
The sheaf $\mu_n$ is often called the \hldef{$n$-Kummer sheaf on $X_{\et}$}, 
\end{definition}