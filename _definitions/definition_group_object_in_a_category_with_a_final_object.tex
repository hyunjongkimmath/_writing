\begin{definition} \label{definition:group_object_in_a_category_with_a_final_object}
    ...
    An \hldef{abelian group object in $\calC$} is a group object as above that also satisfies... \TODO{}

    A \hldef{morphism of group objects in $\calC$} is ...

    The category of group objects may be denoted by notations such as \hl{$\mathbf{Grp}(\calC)$}. 
    The category of abelian group objects may be denoted by notations such as \hl{$\mathbf{Ab}(\calC)$}. 
