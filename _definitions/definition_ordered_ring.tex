\begin{definition}[Ordered ring] \label{definition:ordered_ring}
    \begin{enumerate}
        ...
        \end{enumerate}
        \TextIfExists{definition:ordered_semiring}{
            Equivalently, an ordered ring is exactly a ring that is an \CrefAndHyperrefIfExist{definition:ordered_semiring}{ordered semiring} 
        }
