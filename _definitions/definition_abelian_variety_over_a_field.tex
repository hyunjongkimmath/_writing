\begin{definition}[Abelian variety over a field] \label{definition:abelian_variety_over_a_field}
    ...
    \begin{itemize}
        \item $A$ is a \CrefAndHyperrefIfExist{definition:smooth_morphism_of_schemes}{smooth}, \CrefAndHyperrefIfExist{definition:proper_morphism_of_schemes}{proper}, \CrefAndHyperrefIfExist{definition:geometrically_connected_scheme_over_a_field}{geometrically connected} algebraic variety over $k$,
