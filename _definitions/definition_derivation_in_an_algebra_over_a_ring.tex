\begin{definition} \label{definition:derivation_in_an_algebra_over_a_ring}
    Let $R$ be a \CrefAndHyperrefIfExist{definition:ring}{(not-necessarily commutative) ring with unity} and let $A$ be an \CrefAndHyperrefIfExist{definition:algebra_of_a_ring}{$R$-algebra}. Let $M$ be an \CrefAndHyperrefIfExist{definition:module_of_a_ring}{$A$-module}. 
