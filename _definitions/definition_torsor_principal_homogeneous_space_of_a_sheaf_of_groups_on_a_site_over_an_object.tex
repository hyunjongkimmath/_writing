...
\CrefIfExists{definition:site_induced_by_a_site_on_an_over_category} 
    \begin{enumerate}
        ...
        $$\calP|_{U_i} \cong \calG|_{U_i}$$
        \CrefIfExists{definition:restriction_of_a_sheaf_on_a_site_to_an_object_of_the_underlying_category_of_the_site} as a sheaves with $\calG|_{U_i}$ actions for each $i$.
