...
\begin{enumerate}
    ...
    \item The \CrefAndHyperrefIfExist{definition:left_right_identity_element_of_a_binary_operation}{identity element} is the class of the \CrefAndHyperrefIfExist{definition:ringed_space}{structure sheaf} \CrefAndHyperrefIfExist{definition:algebra_over_a_sheaf_of_rings_on_a_site}{$\mathcal{O}_X$}.
\end{enumerate}
