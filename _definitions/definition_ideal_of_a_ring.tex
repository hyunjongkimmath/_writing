...
\TextIfExists{definition:bimodule_over_rings_module_over_a_ring}{Equivalently, an left/right/two-sided ideal of $R$ is a \CrefAndHyperrefIfExist{definition:submodule_of_a_module_over_a_ring}{submodule} of $R$ as an \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{$R$-module}.}

A left/right/two-sided ideal is said to be \hldef{proper} if it is strictly contained in $R$.

% The abelian group $R$ is itself an $R$-ideal --- it is referred to as the \hldef{unit ideal of $R$}. Moreover, a \hldef{non-trivial ideal of $R$} refers to an ideal that is neither 
