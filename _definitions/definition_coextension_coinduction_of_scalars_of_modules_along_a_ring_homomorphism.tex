\begin{definition} \label{definition:coextension_coinduction_of_scalars_of_modules_along_a_ring_homomorphism}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        This functor is the \CrefAndHyperrefIfExist{definition:adjoint_functors_between_categories_unit_counit_of_adjoint_functors}{right adjoint} to the \CrefAndHyperrefIfExist{definition:restriction_of_scalars}{restriction of scalars functor} $f_*: {}_S\mathsf{Mod} \to {}_R\mathsf{Mod}$.
