\begin{definition}[Biholomorphic map of subsets of $\mathbb{C}$] \label{definition:biholomorphic_map_of_open_subsets_of_general_dimensional_complex_space}
...
\begin{enumerate}
  ...
  \item $f$ and \CrefAndHyperrefIfExist{definition:injective_surjective_bijective_map_of_sets}{$f^{-1}$} are \CrefAndHyperrefIfExist{definition:holomorphic_function_from_a_subset_of_Cn_to_Cm_and_derivative_of_a_holomorphic_function_at_a_point}{holomorphic} on $U$.
\end{enumerate}
