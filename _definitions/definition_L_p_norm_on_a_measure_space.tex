...
Let \( (X, \mathcal{A}, \mu) \) be a measure space. 
    \begin{enumerate}
        \item Let \( 1 \leq p < \infty \). Given a measurable function $f: X \to \bbC$, the \hldef{$L^{p}$-norm} is the \CrefAndHyperrefIfExist{definition:extended_norm_on_a_vector_space_over_a_field_with_absolute_value}{norm} defined by
        $$\hlin{\|f\|_{p} = \left( \int_{X} |f(x)|^{p} \, d\mu(x) \right)^{\frac{1}{p}}.}$$
        

        \item Let \( p = \infty \). Given a measurable function $f: X \to \bbC$, the \hldef{$L^\infty$-norm} is the \CrefAndHyperrefIfExist{definition:extended_norm_on_a_vector_space_over_a_field_with_absolute_value}{norm} defined by
        ...
        $$\hlin{L^{p}(X,A,\mu) = L^{p}(X) \coloneq L^{p}(X, \mu) =\left\{ f : X \to \mathbb{C} \mid f \text{ is measurable and } \|f\|_p < \infty \right\}.}$$
