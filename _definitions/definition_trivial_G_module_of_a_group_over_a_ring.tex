...
\begin{enumerate}
    \item A \hldef{trivial $G$-module over $R$} or a \hldef{trivial $R[G]$-module} is an \CrefAndHyperrefIfExist{}{}$R[G]$-module (say left) $A$ on which $G$ acts trivial, i.e. $ga = a$ for all $g \in G$ and $a \in A$.
