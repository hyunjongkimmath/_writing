...
\begin{definition}[Constant sheaf on a site] \label{definition:constant_sheaf_on_a_site_with_sheafification}
    Let $\calC$ be a \CrefAndHyperrefIfExist{definition:category}{category}, let $\calA$ be a category, and let $A$ be an object of $\calA$. %a set (or more generally, an abelian group, ring, etc.).
