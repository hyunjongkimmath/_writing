...
\begin{enumerate}
    ...
    \end{tikzcd}
    \end{center}
    The monomorphism $m: I \to B$ (or equivalently its subobject class) is called the \hldef{image of $f$ in $\mathcal{C}$}. The morphisms $e$ and $m$ may be suprressed from notation and the image of $f$ may simply be denoted as \hl{$\operatorname{im}(f)$} or \hl{$f(A)$}
    ...
    \end{tikzcd}
    \end{center}
    The epimorphism $e: A \to C$ (or equivalently its quotient class) is called the \hldef{coimage of $f$ in $\mathcal{C}$}. The morphisms $e$ and $m$ may be suprressed from notation and the coimage of $f$ may simply be denoted as \hl{$\operatorname{coim}(f)$}.
