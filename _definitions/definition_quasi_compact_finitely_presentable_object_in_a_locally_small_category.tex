...
Explicitly, this means that for any \CrefAndHyperrefIfExist{definition:diagram_in_a_category_indexed_by_a_category}{filtered diagram} $D: \mathcal{I} \to \mathcal{C}$ such that the \CrefAndHyperrefIfExist{definition:limit_and_colimit_of_a_diagram_in_a_category}{colimit} $\colim_{i \in \mathcal{I}} D_i$ exists in $\mathcal{C}$, the canonical map
