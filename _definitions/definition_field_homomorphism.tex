...
\begin{enumerate}
    ...
    \end{enumerate}
    Equivalently, a field homomorphism is simply a \CrefAndHyperrefIfExist{definition:ring_homomorphism}{ring homomorphism} between fields.

    If such a map exists, we often say that \hldef{$K$ embeds into $L$} and that the map is an \hldef{embedding of $K$ into $L$}; this terminology is justified because field homomorphisms are \CrefAndHyperrefIfExist{definition:injective_surjective_bijective_map_of_sets}{injective} as set maps\CrefIfExists{proposition:field_homomorphism_is_injective}. 
