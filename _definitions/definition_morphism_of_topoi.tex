\begin{definition} {\cite[Expos\'e IV D\'efinition 3.1]{SGA4_I}, see \cite[Definition 2.1]{nlab:geometric_morphism}} \label{definition:morphism_of_topoi}
    Let $E$ and $E'$ be \CrefAndHyperrefIfExist{definition:topos}{topoi} (in a universe $\scrU$, if such a universe is available). A \hldef{(continuous) morphism $f: E \to E'$} is a triple \hl{$f = (f_*, f^*, \varphi)$} consisting of functors
