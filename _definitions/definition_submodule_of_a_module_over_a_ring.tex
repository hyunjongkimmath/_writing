...
\begin{enumerate}
    ...
    \item If $M$ is a \CrefAndHyperrefIfExist{module}{left/right/two-sided $R$-module}, then a \hldef{left/right/two-sided $R$-submodule of $M$} is a submodule of the \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{natural bimodule structure} of $M$.
    % $R$-$\bbZ$/$\bbZ$-$R$/$R$-$R$-submodule of $M$. 
\end{enumerate}

\TextIfExists{definition:subobject_of_an_object_of_a_category}{A submodule of $M$ is a \CrefAndHyperrefIfExist{definition:subobject_of_an_object_of_a_category}{categorical subobject} of $M$ in the appropriate category of modules.}
