...
\begin{definition}[Subcategory] \label{definition:subcategory_of_a_category}
    ...
    \begin{itemize}
        ...
        \item the composition of morphisms in $\mathcal{D}$ is inherited from $\mathcal{C}$ and is closed in $\mathcal{D}$: for morphisms $f \in \mathrm{Hom}_{\mathcal{D}}(X,Y)$ and $g \in \mathrm{Hom}_{\mathcal{D}}(Y,Z)$, their composition $g \circ f$, which is a priori in $\mathrm{Hom}_{\mathcal{C}}(X,Z)$, is in $\mathrm{Hom}_{\mathcal{D}}(X,Z)$.
    \end{itemize}
\end{definition}
