...
A \hldef{rigid category} is a \CrefAndHyperrefIfExist{definition:monoidal_category}{monoidal category} $(\mathcal{C}, \otimes, \mathbb{I})$ in which every object $X \in \mathcal{C}$ admits a \hldef{left dual} \hl{$X^{\vee}$} and a \hldef{right dual} \hl{${}^{\vee}\!X$}, i.e., there exist objects and morphisms
\hlalign{
\begin{align*}
