...
\begin{enumerate}
    ...
    \item For any finite collection $\{ U_1, \ldots, U_n \} \subseteq \mathcal{T}$, the intersection $U_1 \cap \cdots \cap U_n$ is in $\mathcal{T}$. Equivalently, for any $U_1,U_2 \in \calT$, the intersection $U_1 \cap U_2$ is in $\calT$
\end{enumerate}
...
A subset $C \subseteq X$ is \hldef{closed} (also called a \hldef{closed subset}) if its complement $X \setminus C$ is an open set in $\mathcal{T}$
