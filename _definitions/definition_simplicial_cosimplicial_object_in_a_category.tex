\begin{definition} \label{definition:simplicial_cosimplicial_object_in_a_category}
    ...
    \begin{enumerate}
        \item   
        The \hldef{category of simplicial objects in $\mathcal{C}$}, commonly denoted by notations such as \hl{$\mathbf{s}\mathcal{C}$}, \hl{$\operatorname{Simp} \mathcal{C}$}, \hl{$\calC_\Delta$}, or \hl{$(\Delta^{\op})^{\calC}$} (cf. \Cref{definition:diagram_in_a_category_indexed_by_a_category}), or \hl{$\Deltaop C$}, is the \CrefAndHyperrefIfExist{definition:diagram_in_a_category_indexed_by_a_category}{functor category}
        ...
        An object $X$ of $\mathbf{s}\mathcal{C}$ is called a \hldef{simplicial object of $\mathcal{C}$}, and, by definition\CrefIfExists{definition:functor_between_categories}, consists of a family of objects $\{X_n\}_{n \ge 0}$ in $\mathcal{C}$ together with morphisms
        ...
        \item Dually, the \hldef{category of cosimplicial objects in $\mathcal{C}$}, commonly denoted by notatoins such as \hl{$\mathbf{c}\mathcal{C}$}, \hl{$\operatorname{Cosimp} \mathcal{C}$}, or \hl{$\Delta^{\calC}$} (cf. \Cref{definition:diagram_in_a_category_indexed_by_a_category}) is the functor category
        $$
