\begin{definition}[Discrete valuation ring] \label{definition:discrete_valuation_ring}
    ...
    \TODO{make this as a proposition}
    ...
    $$v: K \to \bbZ \cup \{\infty\}.$$
    Conversely, every discrete valuation ring is the \CrefAndHyperrefIfExist{definition:valuation_ring_of_a_nonarchimedean_valued_field}{valuation ring} of a valuation field whose valuation is \CrefAndHyperrefIfExist{definition:discrete_valuation_on_a_field}{discrete}.
\end{definition}
