...
It is also standard to talk of the \hldef{standard topological $n$-simplex} ---  the topological space, often denoted by notations such as \hl{$\Delta^n$} or \hl{$|\Delta^n|$} defined as the subset of Euclidean space $\mathbb{R}^{n+1}$ given by
