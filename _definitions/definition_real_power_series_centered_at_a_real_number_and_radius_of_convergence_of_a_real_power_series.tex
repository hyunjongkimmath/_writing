\begin{definition} \label{definition:real_power_series_centered_at_a_real_number_and_radius_of_convergence_of_a_real_power_series}
    ...
    The \hldef{radius of convergence} of the power series, denoted by \hl{$R$}, is the nonnegative extended real number given by the \CrefAndHyperrefIfExist{proposition:cauchy_hadamard_formula_for_radius_of_convergence_for_power_series_in_one_complex_variable}{Cauchy--Hadamard formula}:
