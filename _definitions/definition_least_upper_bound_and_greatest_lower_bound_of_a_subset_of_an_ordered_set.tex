...
\begin{enumerate}
  \item Assume that $S$ has at least one \CrefAndHyperrefIfExist{definition:upper_and_lower_bounds_of_subsets_of_an_ordered_set}{upper bound} in $X$, i.e.\ there exists $u \in X$ such that $s \leq u$ for all $s \in S$.
  ...
  \end{enumerate}
  \TODO{reference needed: state and prove this}
