...
\begin{itemize}
    ...
    \item Every morphism $f: A \to B$ has a \CrefAndHyperrefIfExist{definition:kernel_and_cokernel_of_a_morphism_in_a_pointed_category}{kernel $\ker(f)$ and a cokernel $\operatorname{coker}(f)$}.
    ...
    $$
    \TODO{I think I need to re-check this definition}
    \TODO{coimage}
\end{itemize}
