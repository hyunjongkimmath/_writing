\begin{definition}[Filtered category] \label{definition:filtered_cofiltered_category}
    ...
    \item Dually, a \hldef{Cofiltered category} is a category whose \CrefAndHyperrefIfExist{definition:opposite_category_of_a_category}{opposite category} is filtered. More explicitly, A cofiltered category is a (nonempty, large) category $\mathcal{I}$ satisfying the following conditions:
