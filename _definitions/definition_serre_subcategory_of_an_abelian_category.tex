\begin{definition}[Serre subcategory] \label{definition:serre_subcategory_of_an_abelian_category}
    ...
    \begin{enumerate}
        ...
        \TODO{extension}
        \item Equivalently, $\mathcal{S}$ is closed under taking \CrefAndHyperrefIfExist{definition:subobject_of_an_object_of_a_category}{subobjects}, \CrefAndHyperrefIfExist{definition:quotient_object_of_an_object_of_an_abelian_category_by_a_subobject}{quotients}, and extensions in $\mathcal{A}$.
    \end{enumerate}
