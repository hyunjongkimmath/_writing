...
and to \CrefAndHyperrefIfExist{definition:infinite_series_and_convergence_of_infinite_series_in_a_topological_abelian_semigroup}{converge} (conditionally) if the sequence of partial sums $\sum_{n=1}^N \frac{a_n}{n^s}$ converges in $\mathbb{C}$ as $N \to \infty$.
