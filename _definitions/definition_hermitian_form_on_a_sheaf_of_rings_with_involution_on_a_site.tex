...
is a \CrefAndHyperrefIfExist{definition:varepsilon_hermitian_form_on_a_module_over_a_ring_with_involution}{hermitian form} on the $\mathcal{O}(U)$-module $\mathcal{E}(U)$ with respect to the \CrefAndHyperrefIfExist{definition:involution_on_a_ring}{involution} $\sigma_U: \mathcal{O}(U) \to \mathcal{O}(U)$.
\end{definition}