\begin{definition} \label{definition:arithmetic_frobenius_morphism_of_a_scheme_over_a_scheme_of_prime_characteristic}
    ...
    where $X^{(p^n)/S}$ denotes the \CrefAndHyperrefIfExist{definition:extension_of_scalars_of_a_scheme_of_prime_characteristic_by_frobenius}{extension of scalars of $X/S$ by the $p^n$th power Frobenius} and $F_{S,p^n}: S \to S$ is the \CrefAndHyperrefIfExist{definition:absolute_p_nth_power_frobenius_morphism_on_a_scheme}{$p^n$th power absolute Frobenius morphism}.  

    In the case that $n = 1$, this is referred to as the \hldef{arithmetic Frobenius morphism of $X/S$}. In the case that the \CrefAndHyperrefIfExist{definition:absolute_p_nth_power_frobenius_morphism_on_a_scheme}{absolute Frobenius morphism $F_S$} on $S$ is invertible, the arithmetic Frobenius morphism of $X/S$ is sometimes referred to as an \hldef{Frobenius automorphism of $S$} (see e.g. \cite[Section I.1]{kiehl_weissauer_wcps}).
