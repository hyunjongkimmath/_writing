...
\begin{enumerate}
    ...
    \item A morphism of schemes $f : X \to Y$ is of \hldef{finite presentation} if it is locally of finite presentation and \CrefAndHyperrefIfExist{definition:quasi_compact_morphism_of_schemes}{quasi-compact} and \CrefAndHyperrefIfExist{definition:quasi_separated_morphism_of_schemes_and_separated_morphism_of_schemes}{quasi-separated}; in particular, $f$ can be covered by finitely many affine opens satisfying the finite presentation condition above.
\end{enumerate}
\end{definition}