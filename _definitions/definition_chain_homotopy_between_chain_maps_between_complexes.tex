...
\begin{enumerate}
    ...
    \item Let $f_\bullet, g_\bullet: C_\bullet \to D_\bullet$ be \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{chain maps between complexes} in $\mathcal{A}$. A \hldef{chain homotopy from $f_\bullet$ to $g_\bullet$} is a collection of morphisms $\{ s_n : C_n \to D_{n+1} \}$ such that for all $n$,
    \[
