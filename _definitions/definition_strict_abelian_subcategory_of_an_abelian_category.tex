...
\begin{enumerate}
    ...
    \item For any morphism $f \in \mathrm{Hom}_{\mathcal{B}}(X,Y)$ with $X,Y \in \mathrm{Ob}(\mathcal{B})$, the \CrefAndHyperrefIfExist{definition:kernel_and_cokernel_of_a_morphism_in_a_pointed_category}{kernel and cokernel} of $f$ computed in $\mathcal{A}$ coincide with the kernel and cokernel of $f$ computed in $\mathcal{B}$.
\end{enumerate}
\end{definition}
