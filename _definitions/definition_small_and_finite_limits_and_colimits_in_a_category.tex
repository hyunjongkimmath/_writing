...
\begin{definition} \label{definition:small_and_finite_limits_and_colimits_in_a_category}
    Let $\mathcal{C}$ be a \CrefAndHyperrefIfExist{definition:category}{(large) category}, let $I$ be a \CrefAndHyperrefIfExist{definition:locally_small_category}{small category}, and let $D: I \to \mathcal{C}$ be a \CrefAndHyperrefIfExist{definition:diagram_in_a_category_indexed_by_a_small_category}{diagram}.
