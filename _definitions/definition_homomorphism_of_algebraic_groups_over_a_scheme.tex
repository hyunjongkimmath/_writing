...
Let $S$ be a scheme, and let $G$ and $H$ be \CrefAndHyperrefIfExist{definition:algebraic_group_scheme_over_a_scheme}{$S$-algebraic groups}. A morphism of $S$-schemes $f: G \to H$ is a \hldef{homomorphism of algebraic groups} if $f$ is a group homomorphism, i.e.,
\begin{itemize}
