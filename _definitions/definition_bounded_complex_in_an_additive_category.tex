...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item $K^\bullet$ is \hldef{cohomologically bounded} if it is both cohomologically bounded above and below, or equivalently if the \CrefAndHyperrefIfExist{definition:homology_and_cohomology_objects_for_a_chain_complex_in_an_abelian_category}{cohomology objects} $H^i(K^\bullet)$ vanish for all but finitely many $i \in \mathbb{Z}$.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item $K_\bullet$ is \hldef{homologically bounded} if it is both homologically bounded above and below, or equivalently if the \CrefAndHyperrefIfExist{definition:homology_and_cohomology_objects_for_a_chain_complex_in_an_abelian_category}{homology objects} $H_i(K_\bullet)$ vanish for all but finitely many $i \in \mathbb{Z}$.
    \end{itemize}
\end{itemize}
\end{definition}
