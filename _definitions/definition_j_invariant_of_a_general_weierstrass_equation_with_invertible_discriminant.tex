\begin{definition}[\hldef{j-invariant} of a General Weierstrass Equation] \label{definition:j_invariant_of_a_general_weierstrass_equation_with_invertible_discriminant}
    ...
    The \hldef{j-invariant} associated to the Weierstrass equation (assuming $\Delta$ is \CrefAndHyperrefIfExist{definition:unit_of_a_ring_invertible_element_of_a_ring_unit_group_of_a_group}{invertible in $R$}) is the element \hl{$j \in R$} given by
    $$ j = \frac{c_4^3}{\Delta}, $$
