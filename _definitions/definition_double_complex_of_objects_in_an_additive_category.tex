...
Let $\mathcal{A}$ be an \CrefAndHyperrefIfExist{definition:additive_category_preadditive_category}{additive category}. A \hldef{double complex} (also called a \hldef{bicomplex}) in $\mathcal{A}$ is a collection of objects
