\begin{definition} \label{definition:kernel_and_cokernel_of_a_morphism_in_a_pointed_category}
...
\begin{enumerate}
    ...
    \TextIfExists{definition:equalizer_and_coequalizer_of_morphisms_in_a_category}{
        Equivalently, $\ker(f)$ is the \CrefAndHyperref{definition:equalizer_and_coequalizer_of_morphisms_in_a_category}{equalizer} of $f$ and the $0$ morphism $X \to Y$, see \Cref{lemma:kernel_cokernel_of_morphisms_in_a_pointed_category_are_equalizers_coequalizers}.
    }
    ...
    \TextIfExists{definition:equalizer_and_coequalizer_of_morphisms_in_a_category}{
        Equivalently, $\coker(f)$ is the \CrefAndHyperref{definition:equalizer_and_coequalizer_of_morphisms_in_a_category}{coequalizer} of $f$ and the $0$ morphism $X \to Y$, see \Cref{lemma:kernel_cokernel_of_morphisms_in_a_pointed_category_are_equalizers_coequalizers}.
    }
