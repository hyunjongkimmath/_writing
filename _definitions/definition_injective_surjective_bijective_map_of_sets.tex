...
\begin{itemize}
  ...
  \TextIfExists{definition:cardinal_number_and_cardinality_of_a_set}{
    By the definition of \CrefAndHyperrefIfExist{definition:cardinal_number_and_cardinality_of_a_set}{cardinality},
  }
\end{itemize}
\end{definition}