...
\input{../_definitions/definition_pointed_object_of_a_category_with_a_final_object.tex}

\input{../_definitions/definition_pointed_sheaves_of_sets_on_a_site_simplicial_pointed_sheaves_of_sets_on_a_site.tex}

\input{../_definitions/definition_pointification_of_an_object_in_a_category_with_a_final_object.tex}

\input{../_concepts/lemma_pointification_and_forgetful_functor_adjunction.tex}
\begin{proof}
...
\input{../_concepts/proposition_elementary_distinguished_square_condition_for_a_presheaf_to_be_sheaf_in_the_nisnevich_topology_over_a_noetherian_scheme_of_finite_dimension.tex}
...
\input{../_definitions/definition_A1_homotopy_theoretic_space_over_a_noetherian_scheme_of_finite_dimension.tex}
...
\input{../_definitions/definition_pointed_space_in_motivic_homotopy_theory.tex}
...
\input{../_definitions/definition_simplicial_weak_equivalences_cofibrations_and_fibrations_for_simplicial_sheaves_on_a_site.tex}


\input{../_concepts/theorem_simplicial_model_category_structure_on_simplicial_sheaves.tex}

\input{../_definitions/definition_simplicial_model_category_structure_on_the_category_of_simplicial_sheaves_on_a_small_site_and_simplicial_homotopy_category_of_a_site.tex}

\subsection{General model structures on categories of simplicial sheaves}

There are two more general model category structures on $\Deltaop(\Shv(T))$ whose theories \cite{morel_voevodsky_1999} relies upon to define the $\bbA^1$-model category structure. One (\Cref{definition:A_local_object_A_weak_equivalence_A_fibration_of_simplicial_homotopy_category_of_sheaves_of_a_small_site}) is defined with respect to a set $A$ of morphisms in \CrefAndHyperrefIfExist{definition:simplicial_model_category_structure_on_the_category_of_simplicial_sheaves_on_a_small_site_and_simplicial_homotopy_category_of_a_site}{$\calH_s(T)$} and the other (\Cref{definition:I_local_weak_I_weak_equivalence_I_weak_fibration_for_morphisms_of_simplicial_sheaves_on_a_site_with_interval}) is defined with respect to a site with interval. The $\bbA^1$-simplicial model structure is a special case of the latter, which in turn is a special case of the former. 
...
\input{../_definitions/definition_A_local_object_A_weak_equivalence_A_fibration_of_simplicial_homotopy_category_of_sheaves_of_a_small_site.tex}

\input{../_concepts/theorem_A_model_category_and_A_localization_fnctor.tex}


\input{../_definitions/definition_interval_in_a_site_with_enough_points.tex}

\input{../_definitions/definition_I_local_weak_I_weak_equivalence_I_weak_fibration_for_morphisms_of_simplicial_sheaves_on_a_site_with_interval.tex}
...
\input{../_concepts/theorem_I_model_category_of_simplicial_sheaves_on_a_small_site_with_interval.tex}
...
% \TODO{Mkae a definition for this?}
...
\input{../_definitions/definition_A1_local_weak_equivalence_fibration_of_simplicial_sheaves_of_sets_on_the_nisnevich_site_over_a_noetherian_finite_dimensional_scheme.tex}
...
\input{../_concepts/lemma_A1_homotopy_theory_is_a_kind_of_interval_homotopy_theory.tex}
\begin{proof}
...
\input{../_definitions/definition_simplicial_model_structure_on_a_category.tex}



\input{../_concepts/proposition_A1_model_structure_on_category_of_simplicial_nisnevich_sheaves.tex}
...
\input{../_concepts/corollary_A1_model_structure_on_simplicial_nisnevich_sheaves_over_a_noetherian_finite_dimensional_scheme_is_an_instance_of_an_I_model_structure.tex}
\begin{proof}
...
\input{../_definitions/definition_A1_model_structure_on_the_category_of_simp_sheaves_of_sets_on_the_nis_site_over_a_noeth_scheme_of_fin_dim_and_the_unstable_A1_homotopy_category.tex}

\input{../_concepts/lemma_pointification_forgetful_functorson_the_unstable_motivic_homotopy_categories_over_a_noetherian_finite_dimensional_scheme.tex}
...
\input{../_definitions/definition_wedge_and_smash_products_of_pointed_simplicial_sheaves_of_sets_on_a_site.tex}
...
\input{../_definitions/definition_simplicial_suspension_functor_and_simplicial_loop_functor_on_pointed_simplicial_sheaves_of_sets_on_a_site.tex}
...
\input{../_definitions/definition_A1_homotopy_group_sheaf_of_an_object_of_the_pointed_unstable_A1_homotopy_category_over_a_noetherian_finite_dimensional_scheme.tex}

We can also define the sheaf of connected components for an unpointed space $X$:
\input{../_definitions/definition_sheaf_of_A1_connected_components_of_an_unbased_space.tex}



\input{../_concepts/lemma_A1_connected_components_of_pointed_space_equals_that_of_underlying_space.tex}
\begin{proof}
...
\input{../_definitions/definition_standard_topological_geometric_simplicial_topological_space.tex}

\input{../_definitions/definition_standard_simplicial_scheme_over_a_scheme.tex}

\input{../_definitions/definition_algebraic_singular_simplicial_set_of_morphisms_from_a_smooth_scheme_to_a_nisnevich_sheaf_of_sets_over_a_noetherian_scheme_of_finite_dimension.tex}

\input{../_definitions/definition_kan_complex.tex}
\input{../_definitions/definition_homotopy_groups_of_a_kan_simplicial_set.tex}

\input{../_definitions/definition_homotopy_groups_of_maps_from_a_smooth_scheme_to_a_sheaf_of_sets_on_the_nisnevich_site_with_respect_to_a_base_point_over_a_noetherian_scheme_of_finite_dimension.tex}

\input{../_definitions/definition_A1_weak_equivalence_of_simplicial_sheaves_of_sets_on_the_nisnevich_topology_over_a_noetherian_finite_dimensional_scheme.tex}
...
\input{../_concepts/theorem_homotopy_category_of_ordinary_sheaves_on_nisnevich_site_is_equivalent_to_unstable_homotopy_category.tex}
...
\input{../_definitions/definition_A1_invariant_strongly_A1_invariant_strictly_A1_invariant_sheaves_of_sets_groups_ab_groups.tex}
...
\input{../_concepts/theorem_sheaf_on_abelian_groups_is_strongly_A1_invariant_iff_strictly_A1_invariant.tex}
...
\input{../_concepts/theorem_A1_homotopy_groups_are_strongly_A1_invariant.tex}
...
\subsection{Milnor-Witt \texorpdfstring{$K$}{K}-theory and the Grothendieck-Witt ring of a field}
 ...
 \input{../_definitions/definition_milnor_witt_K_theory_of_a_field.tex}

 \input{../_definitions/definition_milnor_K_theory_of_a_field.tex}
...
\end{remark}
 ...
 \input{../_definitions/definition_grothendieck_witt_group_of_a_field.tex}

\input{../_concepts/lemma_grothendieck_witt_ring_is_degree_zero_part_of_milnor_witt_k_theory.tex}
...
\input{../_concepts/proposition_category_of_sheaves_is_closed_under_finite_projective_limits_and_arbitrary_corpoducts.tex}
...
\input{../_definitions/definition_site_with_enough_points.tex}
...
\input{../_definitions/definition_free_simplicial_abelian_group_of_a_simplicial_set.tex}
...
\input{../_definitions/definition_smooth_at_a_point_for_a_finite_type_scheme_over_a_field.tex}
