...
\begin{definition} \label{definition:morphism_between_differential_bigraded_objects_in_an_additive_category}
Let $\mathcal{A}$ be an \CrefAndHyperrefIfExist{definition:additive_category_preadditive_category}{additive category}. Let $(E, d)$ and $(F, \delta)$ be two \CrefAndHyperrefIfExist{definition:differential_on_a_bigraded_object_in_an_abelian_category}{differential bigraded objects} in $\mathcal{A}$ where the differentials $d$ and $\delta$ have the same bidegree $(\delta_p, \delta_q)$.
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Each $f^r$ is a \CrefAndHyperrefIfExist{definition:morphism_between_differential_bigraded_objects_in_an_additive_category}{morphism of differential bigraded objects}, i.e., $f^r_{p-r, q+r-1} \circ d^r_{p,q} = \delta^r_{p,q} \circ f^r_{p,q}$;
    ...
    \begin{enumerate}
        \item Each $f_r$ is a \CrefAndHyperrefIfExist{definition:morphism_between_differential_bigraded_objects_in_an_additive_category}{morphism of differential bigraded objects}, i.e., $f_r^{p+r, q-r+1} \circ d_r^{p,q} = \delta_r^{p,q} \circ f_r^{p,q}$;
...
\end{enumerate}
\textit{Remark:} In the limit, if the spectral sequences are convergent, this implies an isomorphism on the abutments. \TODO{define convergence of a spectral sequence}
\end{lemma}


\input{../_definitions/definition_stabilize_for_a_spectral_sequence_in_an_abelian_category_and_infinity_page.tex}

\begin{definition}[{\cite[5.2.11]{weibel}}] \label{definition:weak_convergence_to_a_graded_object_for_a_spectral_sequence_in_an_abelian_category}
    ...
    \begin{enumerate}
        \item Let $E = \{E^r, d^r\}_{r \ge r_0}$ be a \CrefAndHyperrefIfExist{definition:spectral_sequence_in_an_abelian_category}{homological spectral sequence}. We say that $E$ \hldef{weakly converges to $H$}, denoted \hl{$E^r_{p,q} \Rightarrow H_{p+q}$}, if:
        \begin{enumerate}
            ...
            \item Each object $H_n$ is equipped with an \CrefAndHyperrefIfExist{definition:filtration_on_an_object_of_an_abelian_category}{increasing filtration}
        ...
        \item Let $E = \{E_r, d_r\}_{r \ge r_0}$ be a \CrefAndHyperrefIfExist{definition:spectral_sequence_in_an_abelian_category}{cohomological spectral sequence}. We say that $E$ \hldef{weakly converges to $H$}, denoted \hl{$E_r^{p,q} \Rightarrow H^{p+q}$}, if:
        \begin{enumerate}
            ...
            \item Each object $H^n$ (where $H$ is viewed as co-graded, $H^n = H_{-n}$) is equipped with a \CrefAndHyperrefIfExist{definition:filtration_on_an_object_of_an_abelian_category}{decreasing filtration} 
...
\begin{definition}[{\cite[5.2.11]{weibel}}] \label{definition:abuts_to_approaches_a_filtration_for_a_spectral_sequence_in_an_abelian_category}
    Let $\mathcal{A}$ be an \CrefAndHyperrefIfExist{definition:abelian_category}{abelian category}.

    \begin{enumerate}
        \item Let $E = \{E^r, d^r\}_{r \ge r_0}$ be a homological spectral sequence. We say that $E$ \hldef{approaches $H$} (or \hldef{abuts to $H$}) if:
        \begin{itemize}
