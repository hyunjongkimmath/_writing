...
\begin{proposition}[{\cite[Proposition 3.1.11(iii)]}]
    ...
    Assume that there exist a set $I$ and a functor $\lambda: \calA \to \Sets^I$ \CrefIfExists{definition:category_of_sets}\CrefIfExists{definition:diagram_in_a_category_indexed_by_a_small_category} such that 
    \begin{itemize}
