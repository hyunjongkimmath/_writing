...
Define
\hl{$n \times m := g_m(n)$.}
Then $\times: \bbN \times \bbN \to \bbN$, also denoted \hl{$\cdot$}, is a \CrefAndHyperrefIfExist{definition:n_ary_operation_on_a_set}{binary operation} satisfying for all $n, m \in \bbN$:
\begin{enumerate}
    \item $n \times 1 = n$,
