\begin{lemma} \label{lemma:mapping_cone_of_a_map_of_chain_cochain_complexes_in_an_additive_category_fits_into_a_split_exact_sequence}
    ...
    \begin{enumerate}
        ...
        \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{chain complexes} in the additive category $\mathcal{A}$.
        ...
        \longrightarrow 0,
        \]
        where $C_\bullet[-1]$ denotes the shifted \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{chain complex} with
        \[
        ...
        \item The \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{differential} of the cone is
        \[
        ...
        Then there is a natural \CrefAndHyperrefIfExist{definition:short_exact_sequence_in_an_additive_category}{short exact sequence} of \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{cochain complexes}
        \[
