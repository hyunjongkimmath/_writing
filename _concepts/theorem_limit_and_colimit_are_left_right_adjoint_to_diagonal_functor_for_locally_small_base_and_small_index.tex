\begin{theorem} \label{theorem:limit_and_colimit_are_left_right_adjoint_to_diagonal_functor_for_locally_small_base_and_small_index}
    ...
    \begin{enumerate}
        \item If $\mathcal{C}$ admits all \CrefAndHyperrefIfExist{definition:limit_and_colimit_of_a_diagram_in_a_category}{colimits} of \CrefAndHyperrefIfExist{definition:diagram_in_a_category_indexed_by_a_category}{shape} $\mathcal{J}$, then the \CrefAndHyperrefIfExist{theorem:limits_and_colimits_as_functors_from_functor_category_to_value_category}{colimit functor}
