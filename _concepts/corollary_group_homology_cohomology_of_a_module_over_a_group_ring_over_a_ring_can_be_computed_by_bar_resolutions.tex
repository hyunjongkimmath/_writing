...
\begin{enumerate}
    ...
    \begin{itemize}
        \item If $A$ is a left $R[G]$-module, then $H^n(G, A)$ is the \CrefAndHyperrefIfExist{definition:homology_and_cohomology_objects_for_a_chain_complex_in_an_abelian_category}{cohomologies} of the complexes $\Hom_{R[G]-\bbZ}(B_\bullet, A)$ and $\Hom_{R[G]-\bbZ}(\overline{B}_\bullet, A)$, where $B_\bullet$ and $\overline{B}_\bullet$ are constructed as resolutions of left $R[G]$-modules.
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item that \CrefAndHyperrefIfExist{definition:tor_functors_of_bimodules_of_rings}{$\Tor$ functors} of modules can be computed with \CrefAndHyperrefIfExist{definition:left_right_resolution_of_an_object_by_a_class_of_objects_in_an_abelian_category}{projective resolutions} in either input, 
        ...
        \item that \CrefAndHyperrefIfExist{definition:free_bimodule_over_rings}{free modules} are \CrefAndHyperrefIfExist{definition:projective_bimodule_over_rings}{projective} (\Cref{proposition:module_over_ring_is_projective_if_and_only_if_direct_summand_of_a_free_module}).
