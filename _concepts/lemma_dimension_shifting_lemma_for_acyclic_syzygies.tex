\begin{lemma}[Dimension shifting, cf. {\cite[Exercise 2.4.3]{weibel}}] \label{lemma:dimension_shifting_lemma_for_acyclic_syzygies}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item Suppose that $0 \to A \to I \to N \to 0$ is a short exact sequence in $\calA$ where $I$ is $G$-acyclic, and that $A$ and $N$ have \CrefAndHyperrefIfExist{definition:left_right_resolution_of_a_class_of_objects_in_an_abelian_category}{injective resolutions}. We have $R^i G(A) \cong R^{i-1} G(N)$ for $i \geq 2$ and $R^1 G(A) \cong \coker(G(I) \to G(N))$.  
