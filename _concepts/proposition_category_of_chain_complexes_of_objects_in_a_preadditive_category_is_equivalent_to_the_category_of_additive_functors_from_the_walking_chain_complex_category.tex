\begin{proposition} \label{proposition:category_of_chain_complexes_of_objects_in_a_preadditive_category_is_equivalent_to_the_category_of_additive_functors_from_the_walking_chain_complex_category}
Let $\mathcal{B}$ be a \CrefAndHyperrefIfExist{definition:additive_category}{preadditive category}.
