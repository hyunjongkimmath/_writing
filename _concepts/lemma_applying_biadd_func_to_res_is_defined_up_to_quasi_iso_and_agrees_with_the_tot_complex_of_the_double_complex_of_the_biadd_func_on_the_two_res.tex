\begin{lemma} \label{lemma:applying_biadd_func_to_res_is_defined_up_to_quasi_iso_and_agrees_with_the_tot_complex_of_the_double_complex_of_the_biadd_func_on_the_two_res}
    ...
    \begin{enumerate}
        \item Suppose that \CrefAndHyperrefIfExist{definition:left_right_resolution_of_an_object_by_a_class_of_objects_in_an_abelian_category}{left resolutions} $P_{A,\bullet} \to A$ and $P_{B,\bullet} \to B$ exist such that $P_{A,i}$ and $P_{B,i}$ are \CrefAndHyperrefIfExist{definition:flat_object_in_an_abelian_category_with_respect_to_a_right_exact_monoidal_product_functor}{flat} with respect to $F$ on the left and right respectively, i.e. $F(P_{A,i}, -): \calB \to \calC$ and $F(-, P_{B,i}): \calA \to \calC$ are exact for all $i$. 
        ...
        \item Suppose that \CrefAndHyperrefIfExist{definition:left_right_resolution_of_an_object_by_a_class_of_objects_in_an_abelian_category}{right resolutions} $A \to I^{A,\bullet}$ and $B \to I^{B,\bullet}$ exist such that $I^{A,i}$ and $I^{B,i}$ are \CrefAndHyperrefIfExist{definition:flat_object_in_an_abelian_category_with_respect_to_a_right_exact_monoidal_product_functor}{flat} with respect to $F$ on the left and right respectively, $F(I^{A,i}, -): \calB \to \calC$ and $F(-, I^{B,i}): \calA \to \calC$ are exact for all $i$. 
