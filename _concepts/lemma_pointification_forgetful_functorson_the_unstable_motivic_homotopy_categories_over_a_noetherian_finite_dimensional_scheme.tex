\begin{lemma} \label{lemma:pointification_forgetful_functorson_the_unstable_motivic_homotopy_categories_over_a_noetherian_finite_dimensional_scheme}
    ...
    (\Cref{definition:simplicial_model_category_structure_on_the_category_of_simplicial_sheaves_on_a_small_site_and_simplicial_homotopy_category_of_a_site}) and
