\begin{theorem}[Continuity of Adjoint Functors] \label{theorem:right_left_adjoints_commute_with_limits_colimits_of_small_diagrams}
    ...
    \begin{enumerate}
        ...
        Let $D: \mathcal{J} \to \mathcal{D}$ be a \CrefAndHyperrefIfExist{definition:diagram_in_a_category_indexed_by_a_category}{diagram} such that the \CrefAndHyperrefIfExist{definition:limit_and_colimit_of_a_diagram_in_a_category}{limit} $\lim_{\mathcal{J}} D$ exists in $\mathcal{D}$. Then the limit of the composite diagram $G \circ D: \mathcal{J} \to \mathcal{C}$ exists in $\mathcal{C}$, and $G$ \CrefAndHyperrefIfExist{definition:functor_preserving_limit_colimit_of_a_diagram}{preserves the limit}, i.e. the \CrefAndHyperrefIfExist{definition:comparison_morphism_of_limits_and_colimits_under_functors}{comparison morphism} induced by the universal property of the limit,
        $$
