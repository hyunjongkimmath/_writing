...
\TODO{AI generated, verify}
    Let $\bbZ$ be the \CrefAndHyperrefIfExist{definition:ring_of_integers_from_natural_numbers}{ring of integers} and let $\bbZ_{> 0} \subset \bbZ$ be its \CrefAndHyperrefIfExist{definition:positive_cone_in_an_ordered_monoid}{positive cone}. Let $\bbN$ be the \CrefAndHyperrefIfExist{definition:natural_numbers}{set of natural numbers}, regarded as a \CrefAndHyperrefIfExist{definition:totally_ordered_semiring}{totally ordered semiring} via the \CrefAndHyperrefIfExist{definition:standard_order_on_natural_numbers}{standard order on $\bbN$}.
...
\TODO{AI generated, verify}
    ...
    \begin{enumerate}
        ...
        \item $\psi$ preserves unity. The multiplicative identity of $\bbN$ is $1$, and $\psi(1) = [(2,1)] = 1_\bbZ$\CrefIfExists{definition:ring_of_integers_from_natural_numbers}.
