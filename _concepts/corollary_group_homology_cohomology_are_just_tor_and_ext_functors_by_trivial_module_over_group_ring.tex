\begin{corollary} \label{corollary:group_homology_cohomology_are_just_tor_and_ext_functors_by_trivial_module_over_group_ring}
    ...
    \end{enumerate}
    In all of the above statements, $R$ is regarded as a \CrefAndHyperrefIfExist{definition:trivial_G_module_of_a_group_over_a_ring}{trivial $R[G]$-module} and the isomorphisms are natural in $R$ and $A$.
\end{corollary}
\begin{proof}
