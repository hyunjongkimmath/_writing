...
$$\hlin{\lim : \mathcal{C}^\mathcal{J} \to \mathcal{C} \quad \text{(resp. } \colim : \mathcal{C}^\mathcal{J} \to \mathcal{C}\text{)}}$$
from the \CrefAndHyperrefIfExist{definition:diagram_in_a_category_indexed_by_a_category}{functor category} $\mathcal{C}^\mathcal{J}$ to $\mathcal{C}$.
