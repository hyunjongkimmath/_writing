...
\begin{proof}
    \TODO{AI generated, verify}
    We proceed by case analysis on the signs of $m$ and $n$. Recall from \CrefIfExists{definition:power_of_a_group_element_by_an_integer} that for $k \geq 0$, $g^k$ is the power in the underlying monoid, while for $k < 0$, $g^k = (g^{-1})^{-k}$.
