...
\begin{proof}
    ...
    Since $F$ is faithful, it \CrefAndHyperrefIfExist{definition:reflects_a_type_of_morphism_for_a_functor_between_categories}{reflects} \CrefAndHyperrefIfExist{definition:monomorphism_and_epimorphism_in_categories}{monomorphisms and epimorphisms} (\Cref{proposition:full_and_faithful_additive_functor_between_abelian_categories_reflects_exactness}), and morphisms that become equal via $F$ must be equal in $\mathcal{A}$. Hence,
    \[
    \ker(g) = \mathrm{im}(f).
    \]
