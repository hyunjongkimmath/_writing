...
Let $I$ be any set and let $\{\mathcal{A}_i\}_{i \in I}$ be a family of \CrefAndHyperrefIfExist{definition:additive_category_preadditive_category}{additive categories}. 
\begin{enumerate}
