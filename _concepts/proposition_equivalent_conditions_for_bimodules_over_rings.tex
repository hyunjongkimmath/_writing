\begin{proposition} \label{proposition:equivalent_conditions_for_bimodules_over_rings}
    ...
    Let $P$ be an \CrefAndHyperrefIfExist{definition:bimodule_over_rings_module_over_a_ring}{$(R,S)$-bimodule}. The following are equivalent:
    \begin{enumerate}
        \item The functor
        \[
