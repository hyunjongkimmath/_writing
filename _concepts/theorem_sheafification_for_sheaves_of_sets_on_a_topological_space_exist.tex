\begin{theorem} \label{theorem:sheafification_for_sheaves_of_sets_on_a_topological_space_exist}
    ...
    \TextIfExists{theorem:sheafification_of_a_presheaf_of_sets_on_a_small_enough_site}{
        This theorem is a special case of \Cref{theorem:sheafification_of_a_presheaf_of_sets_on_a_small_enough_site} in the case that the site is the \CrefAndHyperrefIfExist{definition:site_of_opens_on_a_topological_space}{site associated to $X$}.
    }
\end{theorem}