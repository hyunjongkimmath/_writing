...
\begin{enumerate}
    ...
    \item If $K$ is a \CrefAndHyperrefIfExist{definition:small_and_finite_limits_and_colimits_in_a_category}{finite field} or a \TODO{maximal extension of a finite field} (such as the field of all roots of unity over a finite field), then $\text{cd}(K) = 1$.
