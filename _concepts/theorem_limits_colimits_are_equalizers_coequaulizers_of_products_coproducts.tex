\begin{theorem} \label{theorem:limits_colimits_are_equalizers_coequaulizers_of_products_coproducts}
    Let $\mathcal{C}$ be a \CrefAndHyperrefIfExist{definition:category}{category}. Let $F: \mathcal{J} \to \mathcal{C}$ be a \CrefAndHyperrefIfExist{definition:diagram_in_a_category_indexed_by_a_category}{diagram} where $\mathcal{J}$ is a \CrefAndHyperrefIfExist{definition:locally_small_category}{small category}. 
