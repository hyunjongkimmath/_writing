\begin{theorem}[Tensor-Hom Adjunction for Bimodules] \label{theorem:tensor_hom_adjunction_for_bimodules_of_rings}
    ...
    \begin{enumerate}
        ...
        Note that $\operatorname{Hom}_{R\text{-}T}$ is the abelian group of $R$-$T$ bimodule homomorphisms, $\operatorname{Hom}_{S\text{-}T}$ is the abelian group of $S$-$T$ bimodule homomorphisms, and $\operatorname{Hom}_R(M,P)$, which is the abelian group of left $R$-linear homomorhisms $M \to P$, is endowed with the structure of an $S$-$T$ bimodule via
        \begin{align*}
