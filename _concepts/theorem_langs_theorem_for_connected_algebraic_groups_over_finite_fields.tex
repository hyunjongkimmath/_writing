...
Let $\Fq$ be a finite field of characteristic $p$ with $q$ elements, let $G$ be a connected algebraic group over $\Fq$, and let $F$ be the \CrefAndHyperrefIfExist{definition:relative_frobenius_morphism_of_a_scheme_over_a_scheme_of_prime_characteristic}{relative $q$th power Frobenius endomorphism on $G/\Fq$}. The \CrefAndHyperrefIfExist{definition:lang_map_of_an_endomorphism_of_an_algebraic_group}{Lang map associated to $F$} is a separable Galois \'etale (surjective) isogeny whose kernel is precisely $G(\Fq)$, the group of $\Fq$-points of $G$.
