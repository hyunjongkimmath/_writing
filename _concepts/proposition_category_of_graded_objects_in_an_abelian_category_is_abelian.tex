\begin{proposition} \label{proposition:category_of_graded_objects_in_an_abelian_category_is_abelian}
    ...
    The category \CrefAndHyperrefIfExist{definition:category_of_graded_objects_in_a_category}{$\text{Gr}(\mathcal{A})$} is an abelian category.
    \CrefAndHyperrefIfExist{definition:limit_and_colimit_of_a_diagram_in_a_category}{Limits, colimits}, \CrefAndHyperrefIfExist{definition:kernel_and_cokernel_of_a_morphism_in_a_pointed_category}{kernels, and cokernels} in \hl{$\text{Gr}(\mathcal{A})$} are formed component-wise in $\mathcal{A}$. 
