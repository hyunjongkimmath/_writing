...
\input{../_concepts/proposition_equivalent_conditions_projective_injective.tex}
...
\input{../_concepts/proposition_free_bimodule_over_rings_are_projective.tex}
...
\begin{problem}
    ...
    Show that $f$ is \CrefAndHyperrefIfExist{definition:chain_homotopy_between_chain_maps_between_complexes}{null-homotopic} via a chain homotopy $s$ if and only if $f$ extends to a chain map $\operatorname{cone}(f) \to D$ given by $(-s, f)$. 
\end{problem}
