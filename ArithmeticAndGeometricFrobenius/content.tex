...
\begin{proposition} \label{proposition:twist_of_scheme_is_isomorphic_to_scheme_if_absolute_frobenius_on_base_is_identity}
    Let $X$ be a scheme over an $S$-scheme of prime characteristic $p$. For $n \geq 0$, assume that the \CrefAndHyperrefIfExist{definition:absolute_frobenius_morphism_on_a_scheme}{$p^n$th power absolute Frobenius morphism $F_{S, p^n}: S \to S$} is the identity morphism on $S$. The \CrefAndHyperrefIfExist{definition:extension_of_scalars_of_a_scheme_of_prime_characteristic_by_frobenius}{extension of scalars/twist $X^{(p^n)}$} is naturally isomorphic to $X$ as an $S$-scheme. 
\end{proposition}
\begin{proof}
...
\begin{proposition} \label{proposition:arithmetic_and_geometric_frobenius_details}
    ...
    \begin{enumerate}
        ...
        \item Assume that the \CrefAndHyperrefIfExist{definition:absolute_frobenius_morphism_on_a_scheme}{absolute Frobenius morphism on $S$} is invertible. For $n \geq 0$, the \CrefAndHyperrefIfExist{definition:geometric_frobenius_of_a_scheme_over_a_scheme_of_prime_characteristic_with_invertible_absolute_frobenius}{geometric $p^n$th power Frobenius morphism} $X^{(1/p^n)} \to X$ \label{part:geometric_frobenius_details}
...
\begin{lemma} \label{lemma:there_is_an_isomorphism_from_an_etale_sheaf_on_a_scheme_of_characteristic_p_to_its_pushforward_under_frobenius}
    ...
    where 
    \begin{itemize}
    \item \CrefAndHyperrefIfExist{definition:absolute_frobenius_morphism_on_a_scheme}{$\Frob_{X, p^n}: X \to X$} is the \CrefAndHyperrefIfExist{definition:absolute_frobenius_morphism_on_a_scheme}{$p^n$th power Absolute Frobenius morphism of $X$}, and
