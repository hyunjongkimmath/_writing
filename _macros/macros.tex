...
% Solution
\newaliascnt{solution}{theorem}
\newtheorem{solution}[solution]{Solution}
\aliascntresetthe{solution}
...
\newcommand{\FinSets}{\mathbf{FinSets}}
