...
\begin{proposition}
    Let $M$ be a $n$-dimensional (real) $C^k$-manifold for $k \in \bbN_0 \cup \{\infty\}$ and let $E$ be a $C^k$-vector bundle of rank $r$ on $M$. The \CrefAndHyperrefIfExist{definition:kth_exterior_power_of_vector_space_over_a_field}{$l$-th exterior power} $\bigwedge^l E$ is a $C^k$-vector bundle of rank ${r\choose k}$.
\end{proposition}
