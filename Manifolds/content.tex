...
\input{../_definitions/definition_topological_manifold.tex}
\input{../_definitions/definition_chart_on_a_topological_manifold.tex}
\input{../_definitions/definition_atlas_on_a_topological_manifold.tex}
\input{../_definitions/definition_transition_map_between_charts_on_a_topological_manifold.tex}
...
\input{../_definitions/definition_C_k_map_between_open_subsets_of_closed_half_spaces_of_Rns.tex}

\input{../_definitions/definition_C_k_compatible_charts_on_a_topological_manifold.tex}
\input{../_definitions/definition_C_k_atlas_on_a_topological_manifold.tex}
\input{../_definitions/definition_C_k_manifold.tex}
\input{../_conventions/convention_C_k_for_k_equal_0_means_continuous_whereas_C_k_for_k_equal_infty_means_smooth.tex}
...
\input{../_definitions/definition_C_k_vector_bundle_on_a_C_k_manifold.tex}

\input{../_concepts/theorem_total_space_of_a_C_k_vector_bundle_is_a_C_k_manifold.tex}
...
\input{../_definitions/definition_morphism_of_C_k_vector_bundles_over_a_C_k_manifold_with_or_without_boundary.tex}



\input{../_definitions/definition_dual_bundle_of_a_C_k_vector_bundle.tex}

\input{../_definitions/definition_support_of_a_section_of_a_C_k_vector_bundle_over_a_C_k_manifold.tex}

\begin{lemma}
    Let $M$ be a \CrefAndHyperrefIfExist{definition:C_k_manifold}{$C^k$-manifold with or without boundary} and let $E \to M$ be a \CrefAndHyperrefIfExist{definition:C_k_vector_bundle_on_C_k_manifold}{$C^k$ vector bundle}. 
...
\input{../_definitions/definition_tangent_space_of_a_topological_manifold_at_a_point.tex}

\input{../_definitions/definition_tangent_bundle_of_a_C_k_manifold.tex}

\input{../_definitions/definition_cotangent_bundle_of_a_C_k_manifold.tex}
...
\input{../_definitions/definition_symmetric_power_of_a_vector_bundle_on_a_topological_manifold.tex}


\input{../_definitions/definition_exterior_power_of_a_vector_bundle_on_a_topological_manifold.tex}

\begin{proposition}
    Let $M$ be a $n$-dimensional (real) $C^k$-manifold for $k \in \bbN_0 \cup \{\infty\}$ and let $E$ be a $C^k$-vector bundle of rank $r$ on $M$. The \CrefAndHyperrefIfExist{definition:exterior_power_of_a_vector_space_over_a_field}{$l$-th exterior power} $\bigwedge^l E$ is a $C^k$-vector bundle of rank ${r\choose k}$.
\end{proposition}

\subsection{\texorpdfstring{$k$}{k}-forms on a smooth real manifold}

\input{../_definitions/definition_bundle_of_l_forms_on_a_C_k_manifold.tex}

% \input{../_definitions/definition_k_form_on_a_smooth_manifold.tex}

\TODO{TODO: read the following four definitions}

\input{../_definitions/definition_exterior_derivative_on_smooth_k_forms_on_a_smooth_manifold.tex}
...
\end{enumerate}
Both are \CrefAndHyperrefIfExist{definition:chain_complex_of_objects_in_a_preadditive_category}{chain complexes} of $\bbR$-vector spaces.
...
\input{../_definitions/definition_complex_analytic_manifold.tex}
\input{../_definitions/definition_almost_complex_structure_on_a_smooth_manifold_of_even_dimension.tex}
\input{../_definitions/definition_integrable_almost_complex_structure_on_a_smooth_manifold_of_even_real_dimension.tex}

\input{../_concepts/proposition_complex_manifold_is_equivalent_to_a_smooth_manifold_with_an_integrable_almost_complex_structure.tex}

\section{Vector fields}

\input{../_definitions/definition_local_and_global_vector_field_on_a_C_k_manifold.tex}


\input{../_definitions/definition_local_and_global_frames_of_the_tangent_bundle_of_a_differentiable_manifold.tex}



\section{Orientation on manifolds}

\input{../_definitions/definition_orientation_of_a_real_vector_space.tex}

\input{../_definitions/definition_standard_orientation_on_R_n.tex}


\input{../_definitions/definition_orientation_of_a_differentiable_manifold_with_or_without_boundary.tex}



% \input{../_definitions/definition_canonical_orientation_of_a_chart_on_a_topological_manifold.tex}
...
\input{../_definitions/definition_closed_half_space_in_euclidean_space.tex}
