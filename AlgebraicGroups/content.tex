...
\begin{lemma}
    \TODO{define $S_\varepsilon$}
\end{lemma}

\TODO{construct the space of hermitian forms and the space of even hermtiian forms as in Knus}
\begin{definition}
    \TODO{define the even $\varepsilon$ hermitian forms}
\end{definition}
\input{../_definitions/definition_sesquilinear_space_varepsilon_hermitian_space.tex}
